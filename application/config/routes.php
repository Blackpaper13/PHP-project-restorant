...
$route['customer/hasil'] = 'pelanggan/hasil';
$route['customer/barcode_qrcode/(:num)'] = 'pelanggan/barcode_qrcode/$1';
$route['customer/barcode_print/(:num)'] = 'pelanggan/barcode_print/$1';
$route['customer/qrcode_print/(:num)'] = 'pelanggan/qrcode_print/$1';
