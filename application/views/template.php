...
<head>
  ...
  <title>AKB Atma | Administrator</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=base_url('dashboard')?>" class="logo">
      ...
      <span class="logo-lg"><b>AKB</b>Admin</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <?=$this->fungsi->user_login()->name?>
                  <small>Tanggal Masuk Kerja : <?=$this->fungsi->user_login()->tanggal_masuk?></small>
                  <small>Alamat : <?=$this->fungsi->user_login()->address?></small>
                </p>
              </li>
              <!-- Menu Footer-->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
            <a href="<?=site_url('order')?>"><i class="fa fa-credit-card"></i><span>Order Customer</span></a>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <li <?=$this->uri->segment(1) == 'category' ? 'class="active"' : ''?>><a href="<?=site_url('category')?>"><i class="fa fa-circle-o"></i> Categories</a></li>
            ...
            <li <?=$this->uri->segment(1) == 'items' ? 'class="active"' : ''?>><a href="<?=site_url('item')?>"><i class="fa fa-circle-o"></i> Items</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?=site_url('stock/in')?>"><i class="fa fa-circle-o"></i> Bahan Masuk</a></li>
            <li><a href="<?=site_url('stock/out')?>"><i class="fa fa-circle-o"></i> Bahan Keluar</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li>
            <a href="<?=site_url('meja')?>"><i class="fa fa-table"></i><span>Meja</span></a>
        </li>
        <?php } ?>
      </ul>
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="https://adminlte.io">AKB Atma</a>.</strong> All rights
    reserved.
  </footer>
